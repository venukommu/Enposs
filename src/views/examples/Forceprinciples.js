                  ...
                  <Row>
                    ...
                    <h1 className="display-1 text-white text-lead"
                      ...
                      <h3 className="display-4 text-info"
                        ...
                        FORCE operates on the principle of APSIC. Using tourmaline nano-particles, FORCE improves the flow of electricial current and absorbs energy losses.This dual action gives you energy efficient smart homes.</h3>
                    </Col>
                  </Row>
                </div>
              </Container>
                    ...
                    <Col lg="12">
                      <Card className="shadow border-0">
                        ...
                        <h4 className="display-3 font-weight-bold text-primary">
                          ...
                          In other words, FORCE will improve the current flow and reduce electric power consumption.
                          </p>
                          <Row className="justify-content-center">
                          <Col lg="8">
                          <CardImg
